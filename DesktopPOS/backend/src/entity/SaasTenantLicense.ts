...
export class SaasTenantLicense {
  ...
  /** Terminaux desktop/agent connectés ; null = illimité */
  @Column('int', { nullable: true })
  ...
  /** Plans d'abonnement autorisés pour les terminaux (ex: BASIC, PRO, ENTERPRISE). */
  @Column({ type: 'jsonb', nullable: true })
  allowedTerminalPlans!: string[] | null;

  /** Plan actuellement appliqué globalement au tenant. */
  @Column('varchar', { length: 32, nullable: true })
  activePlanCode!: string | null;

  /**
   * Mapping modules par plan:
   * { BASIC: ["pos"], PRO: ["pos","analytics"], ENTERPRISE:[...] }
   */
  @Column({ type: 'jsonb', nullable: true })
  modulesByPlan!: Record<string, string[]> | null;
