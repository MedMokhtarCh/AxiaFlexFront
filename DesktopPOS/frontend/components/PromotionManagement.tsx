...
const PromotionManagement: React.FC<PromotionManagementProps> = ({
  ...
  const TOUR_STEPS: Array<{
    ...
    {
      title: "Nom et type",
      desc: "Donne un nom puis choisis le type de promotion.",
      target: () => nameInputRef.current || typeSelectRef.current,
    },
    {
      title: "Planification",
      desc: "Renseigne la date de début et la date de fin.",
      target: () => scheduleSectionRef.current,
    },
    {
      title: "Configuration",
      desc: "Choisis les produits et paramètres selon le type.",
      target: () => configSectionRef.current,
    },
    {
      title: "Validation",
      desc: "Clique sur Enregistrer pour publier.",
            ...
            <div className="flex flex-col md:flex-row gap-6 p-6 overflow-auto">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div
                  ...
                  className={`space-y-3 p-2 transition ${tourGlowClass(1)}`}
                >
                  <h4 className="text-sm font-semibold text-slate-700 flex items-center gap-2">
                ...
                <div
                  ...
                  className={`space-y-3 p-2 transition ${tourGlowClass(2)}`}
                >
                  <h4 className="text-sm font-semibold text-slate-700 flex items-center gap-2">
