...
const CashManagement: React.FC = () => {
  ...
  }, [fundSessionHistory, funds, settings.currency]);
    ...
    <div className="touch-cash-page max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      >
        <button
          ...
          className={`text-left rounded-2xl border p-4 transition-all ${cashView === "operations" ? "border-indigo-300 bg-indigo-50 ring-2 ring-indigo-200" : "border-slate-100 bg-white hover:border-slate-200"}`}
        >
        ...
        <button
          ...
          className={`text-left rounded-2xl border p-4 transition-all ${cashView === "servers" ? "border-indigo-300 bg-indigo-50 ring-2 ring-indigo-200" : "border-slate-100 bg-white hover:border-slate-200"}`}
        >
          <div className="flex items-center gap-2 text-indigo-600">
            <Users size={18} />
            <span className="font-black text-[10px] uppercase tracking-widest">
        ...
        <button
          ...
          className={`text-left rounded-2xl border p-4 transition-all ${cashView === "history" ? "border-indigo-300 bg-indigo-50 ring-2 ring-indigo-200" : "border-slate-100 bg-white hover:border-slate-200"}`}
        >
          <div className="flex items-center gap-2 text-indigo-600">
            <History size={18} />
            <span className="font-black text-[10px] uppercase tracking-widest">
